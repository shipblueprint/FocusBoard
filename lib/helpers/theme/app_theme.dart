...
import 'package:focusboard/helpers/widgets/my_breadcrumb_item.dart';
import 'package:focusboard/helpers/widgets/my_constant.dart';
import 'package:focusboard/helpers/widgets/my_screen_media.dart';
...
class AppStyle {
  ...
  static void initMyStyle() {
    ...
    // Note: Google Fonts disabled at compile-time to avoid the
    // `Constant evaluation error` in offline sandboxes. Re-enable
    // `GoogleFonts.poppins()` when network access is available.
    My.changeTheme(AppTheme.theme);
    My.setConstant(MyConstantData(
      ...
      defaultBreadCrumbItem:
          MyBreadcrumbItem(name: 'Henox', route: '/client/home'),
    ));
    bool isMobile = true;
    try {
